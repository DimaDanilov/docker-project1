...
class getDoctrineMongodb_Odm_DefaultDocumentManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/Core/User/Document'), 1 => (\dirname(__DIR__, 4).'/src/Core/Pizzas/Document')]);

        $c->addDriver($d, 'App\\Core\\User\\Document');
        $c->addDriver($d, 'App\\Core\\Pizzas\\Document');

        $a->setDocumentNamespaces(['AppCoreUser' => 'App\\Core\\User\\Document', 'AppCorePizzas' => 'App\\Core\\Pizzas\\Document']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\MongoDBBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Core\\Pizzas\\Repository\\PizzaRepository' => ['privates', 'App\\Core\\Pizzas\\Repository\\PizzaRepository', 'getPizzaRepositoryService', true],
            ...
            'App\\Core\\Pizzas\\Repository\\PizzaRepository' => '?',
