...
{
    /**
     * Gets the private 'App\Core\Pizzas\Repository\PizzaRepository' shared autowired service.
     *
     * @return \App\Core\Pizzas\Repository\PizzaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Core/Pizzas/Repository/PizzaRepository.php';

        return $container->privates['App\\Core\\Pizzas\\Repository\\PizzaRepository'] = new \App\Core\Pizzas\Repository\PizzaRepository(($container->services['doctrine_mongodb'] ?? $container->getDoctrineMongodbService()));
    }
}
